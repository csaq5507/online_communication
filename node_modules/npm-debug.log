...
1 verbose cli [ '/usr/bin/nodejs', '/usr/bin/npm', 'stop', '../server.js' ]
...
5 verbose cwd /home/ivan/Webserver/oc/online_communication/node_modules
6 error Linux 4.13.0-39-generic
7 error argv "/usr/bin/nodejs" "/usr/bin/npm" "stop" "../server.js"
8 error node v4.2.6
9 error npm  v3.5.2
